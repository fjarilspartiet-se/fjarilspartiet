...
---
dokumentid: TAK-404
titel: Lokal bostadspolicy – En synoptisk policycykel
version: 1.0
...
Vi använder **SCI‑cykeln** (Synthesis, Challenge, Integration) för att säkerställa att policyutvecklingen:
- Bygger på många perspektiv (Synthesis)
- Utmanas kritiskt (Challenge)
- Integrerar insikter till en helhetssyn (Integration)
...
- **Boende** i olika åldrar och inkomstnivåer
- **Arkitekter, stadsplanerare och hållbarhetsexperter**
- **Individuella bostadsrättsföreningar och hyresgästföreningar**
- **Klimat- och ekologirörelser**
- **Kommunala tjänstemän och politiker**
- **Ungdomsråd och framtidsgenerationer**

### **2.2. Nyckelfrågor identifierade**
1. **Tillgänglighet** – pris, köer, tillträde för unga och äldre
2. **Hållbarhet** – energi, material, klimatanpassning
3. **Gemenskap** – grönområden, mötesplatser, trygghet
4. **Rättvisa** – segregation, diskriminering, social mix
5. **Demokrati** – medborgardeltagande i planeringen
...
- **Är den motståndskraftig mot korruption?** Finns det mekanismer som förhindar att fastighetsintressen kapar processen?

### **3.3. Resultat efter "steel-manning"**
Vi slutar slåss mot fysikens och juridikens lagar. Istället använder vi dem som spakar.

| Tidigare strategi            | Ny strategi – "Hacken"                                                                                 |
|------------------------------|---------------------------------------------------------------------------------------------------------|
| Tvingande krav i detaljplan  | Frivilliga men oemotståndliga incitament i markanvisningen                                             |
| Social mix som moraliskt krav| Nyckelpersonsbostäder för samhällsviktig personal (sjuksköterskor, poliser, lärare, räddningstjänst)   |
| Bindande medborgarassembléer | Kvalificerat rådgivande organ med offentlig rapporteringsplikt och politisk självmordsmekanism         |
| Pristak                      | Densitet som valuta – ju mer samhällsnytta, desto fler kvadratmeter man får bygga                      |
...
|-----------------------------------------------|-------------------------------------|
| 100 % klimatpositiv livscykelcertifiering (NollCO2 eller liknande) | +25 %                              |
| Minst 30 % av bostäderna överlåts till en Community Land Trust (se pelare 3) | +20 %                              |
| Minst 40 % nyckelpersonsbostäder (se pelare 2) | +15 %                              |
| Biophilic design enligt kommunens nya bioregionala checklista | +10 %                              |
| Gemenskapsnav (min 300 kvm) i bottenvåning    | +10 %                              |

Maximal bonus: +80 % exploateringsgrad.  
...
- Kommunen tecknar civilrättsligt optionsavtal med byggherren i markanvisningen (fullt lagligt).

Resultat: NIMBY-grannen kan inte längre säga ”bidragstagare” – hen måste säga ”jag vill inte ha polisen som granne”.

#### Pelare 3 – Bostadscirkeln (Community Land Trust på svenska)
- Marken säljs eller upplåts med tomträtt till en ideell förening (CLT) som äger marken för evigt.
- Byggherren bygger husen och säljer bostadsrätterna/hyresrätterna med 70–99-års avtal.
- Återförsäljningspris regleras till max RPI + 2 % per år.
...
- Byggherrar som uppnår certifikatet får:
  ...
  - Fast-track handläggning (max 10 veckor istället för 18–24 månader)
...
3. **Den är epistemiskt sund** – den stress‑testas mot bias, intressen och framtidsosäkerhet.
4. **Den är konkret** – den går från vision till pilot till norm.
...
- **Skapa en “Policy‑laboratorium”‑sida** på vår hemsida där denna process dokumenteras live.
